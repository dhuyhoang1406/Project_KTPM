...
public class AuthExceptionHandler implements AuthenticationEntryPoint, AccessDeniedHandler {
    ...
    public void commence(HttpServletRequest request,
        ...
        String message = "Đăng nhập thất bại !! (1)";
    ...
    public void globalBanHandle(HttpServletResponse response,
                                GlobalBanException customException) throws IOException {
        String message = "Tài khoản của bạn đã bị khóa !!";
        int code = 10;
        String moreInformation = "http://localhost:8080/api/v1/exception/" + code;

        ErrorResponse errorResponse = new ErrorResponse(message, null, null, code, moreInformation);
