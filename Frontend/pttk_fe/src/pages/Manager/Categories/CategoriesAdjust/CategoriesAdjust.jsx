...
import { createCategory, getCategory, updateCategory } from "../../../../services/CategoriesService";
        ...
        <div className={styles.wrapper}>
            ...
            <div className={styles.boxFeature}>
                <div>
                    ...
                    <p style={{fontSize:"1.1rem",fontWeight:"700"}}>Loại Sản Phẩm / Xem và chỉnh sửa</p>
                </div>
                <div>
                    <button style={{fontFamily:"Arial",fontSize:"1.5rem",fontWeight:"700",border:"1px solid rgb(140,140,140)",backgroundColor:"white",color:"rgb(80,80,80)",padding:"1rem 2rem 1rem 2rem",borderRadius:"0.6rem",cursor:"pointer"}} onClick={()=>{isCEO !== "CEO" ? navigate("/system/manager/categories") : navigate("/system/ceo/categories")}}>Hủy</button>
            ...
            <div className={styles.boxTable}>
                ...
                <div style={{display:'flex',padding:"0rem 1rem 0rem 1rem",justifyContent:"space-between"}}>
                    <div>
                        <p style={{fontWeight:"700",fontSize:"1.5rem"}}>Chi tiết loại sản phẩm</p>
                        <div>
                            <div style={{display:'flex',gap:"2rem"}}>
                                ...
                                <div>
                                    ...
                                    <input className={styles.input} value={name&&name} onChange={(event)=>setName(event.target.value)} style={{width:"70rem"}} placeholder="Tên loại sản phẩm"/>
                                </div>
                            </div>
                        </div>
                    </div>
