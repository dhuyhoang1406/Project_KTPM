...
import styles from "./AnalystSpend.module.scss"
import { CategoryScale, Chart as ChartJS, LinearScale, LineElement, PointElement, Title } from "chart.js";
import { Chart } from 'react-chartjs-2';
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faBookBookmark, faMoneyBill, faReceipt, faWarehouse } from "@fortawesome/free-solid-svg-icons";
            ...
            <div className={styles.boxTable}>
                <div style={{display:'flex',gap:'1.5rem'}}>
                    <div style={{display:'flex',alignItems:'center',gap:"1rem",backgroundColor:"#e91e63",width:"62rem",padding:"1rem"}}>
                      ...
                      <div>
                        <p style={{color:'white',fontWeight:'700'}}>Tổng Số Chi Tiêu</p>
